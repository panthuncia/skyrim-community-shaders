...
static const uint CS_DEFERRED_ABI_VERSION = 5u;
...
static const uint CS_CONTEXT_USES_SOFT_LIGHTING = 1u << 5;
static const uint CS_CONTEXT_USES_RIM_LIGHTING = 1u << 6;
static const uint CS_CONTEXT_USES_BACK_LIGHTING = 1u << 7;
